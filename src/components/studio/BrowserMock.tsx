...
/**
 * A lightweight fake browser window used as a thumbnail. If an image URL is
 * provided it's shown inside the frame; otherwise a labelled gradient is used.
 */
export function BrowserMock({ label, gradient, image, className = '' }: Props) {
  return (
